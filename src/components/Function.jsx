...
export default class Function extends React.Component {
  render() {
    return (
      <Table className='reactdump reactdump-Function' >
        <RowHeader className='reactdump-label reactdump-Function' label={this.props.opts.label} expand={this.props.opts.expand} cols='1' />
